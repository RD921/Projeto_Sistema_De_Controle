...
router.post("/tickets/:id/avaliacao", auth, ctrl.avaliarTicket);
router.get("/tickets/:id/avaliacao", auth, ctrl.buscarAvaliacaoTicket);
router.get("/qualidade/indicadores", auth, ctrl.indicadoresQualidade);
